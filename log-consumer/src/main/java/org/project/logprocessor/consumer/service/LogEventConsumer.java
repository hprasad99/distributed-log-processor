...
public class LogEventConsumer {
    ...
    public LogEventConsumer(MeterRegistry meterRegistry) {
        this.processedCounter = Counter.builder("log_events_processed_total").description("Total number of log events processed").register(meterRegistry);
        this.errorCounter = Counter.builder("log_events_errors_total").description("Total number of log event processing errors").register(meterRegistry);
    }
    ...
    private void processLogEvent(LogEvent logEvent) {
        try{
            ...
            logger.info("Processed log event: {} for organization: {}", logEvent.getId(), logEvent.getOrganizationId());
